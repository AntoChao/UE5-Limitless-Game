...
void AEnemy10_Robot_Papu::BeginPlay()
{
	Super::BeginPlay();
	...
	SetRarity(EEnemyRarity::EElite);

	GeneralDistance = 2000.0f;

	AbilityOneDistance = 1300.f;
	AbilityTwoDistance = 1300.f;
	AbilityThreeDistance = 1300.f;
