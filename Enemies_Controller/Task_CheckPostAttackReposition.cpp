...
#include "Task_CheckPostAttackReposition.h"
...
EBTNodeResult::Type UTask_CheckPostAttackReposition::
ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	OwnerComp.GetBlackboardComponent()
		->SetValueAsVector(FName("RePosition"), Enemy->GetPostAttackReposition());
