...
#include "Task_CheckAbility2Avaliability.h"
...
EBTNodeResult::Type UTask_CheckAbility2Avaliability::
ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	OwnerComp.GetBlackboardComponent()
		->SetValueAsBool(FName("Is Able To Use Ability Two"), Enemy->IsAbleToUseAbility2());
