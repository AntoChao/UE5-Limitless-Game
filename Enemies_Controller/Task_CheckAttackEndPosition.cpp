...
#include "Task_CheckAttackEndPosition.h"
...
EBTNodeResult::Type UTask_CheckAttackEndPosition::
ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	OwnerComp.GetBlackboardComponent()
		->SetValueAsVector(FName("Attack End Position"), Enemy->GetAttackFinishedPosition());
