...
#include "Task_CheckAbility3Avaliability.h"
...
EBTNodeResult::Type UTask_CheckAbility3Avaliability::
ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	OwnerComp.GetBlackboardComponent()
		->SetValueAsBool(FName("Is Able To Use Ability Three"), Enemy->IsAbleToUseAbility3());
