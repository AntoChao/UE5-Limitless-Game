...
#include "Task_CheckAbility1Avaliability.h"
...
EBTNodeResult::Type UTask_CheckAbility1Avaliability::
ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	OwnerComp.GetBlackboardComponent()
		->SetValueAsBool(FName("Is Able To Use Ability One"), Enemy->IsAbleToUseAbility1());
